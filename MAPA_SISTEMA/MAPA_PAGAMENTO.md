...
Ou seja: o CA configura o gateway em **Negócios → Recebíveis**, escolhendo o estabelecimento e conectando via OAuth (PagBank), informando Secret Key (Pagar.me) ou Access Token JSON (Mercado Pago) com integração (hoje só Mercado Pago) com credenciais e opções ativo/padrão/teste.
