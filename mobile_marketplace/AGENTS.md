...
Documentação macro vive em `../.cursor/plans/plano_app_mobile_marketplace.plan.md` (plano por fases) e `../MAPA_SISTEMA/MAPA_DO_SISTEMA.md` (sistema completo). Índice geral: `../MAPA_SISTEMA/INDICE.md`.
...
#   - Backend em produção/staging:                       https://www.ibix.com.br/api/v1
...
7. **Atualize a documentação macro** (`../.cursor/plans/plano_app_mobile_marketplace.plan.md` e `../MAPA_SISTEMA/MAPA_DO_SISTEMA.md`) quando adicionar um endpoint novo, mudar contrato ou criar tela importante.
...
- **Plano completo do app:** `../.cursor/plans/plano_app_mobile_marketplace.plan.md`
