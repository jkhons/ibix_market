"""Permissão fiscal.empresa.criar apenas para Superadministrador e Administrador.

Revision ID: c33dd035p5m2
Revises: aa99bb691c5l1
Create Date: 2026-02-08

Cria a permissão fiscal.empresa.criar (criar nova empresa fiscal).
Atribui apenas às roles Superadministrador e Administrador.
Cliente Administrador não pode criar nova empresa; apenas visualizar/editar as do seu escopo.
"""
from alembic import op
from sqlalchemy import text

revision = "c33dd035p5m2"
down_revision = "aa99bb691c5l1"
branch_labels = None
depends_on = None

PERMISSAO_NOME = "fiscal.empresa.criar"
PERMISSAO_DESCRICAO = "Criar nova empresa fiscal (apenas Superadministrador e Administrador)"
MODULO = "fiscal"
ACAO = "criar"
