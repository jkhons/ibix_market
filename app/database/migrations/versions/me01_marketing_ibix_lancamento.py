...
_POSTS = [
    ...
    # Calendário vigente: Dia 1 = 03/08/2026 · Dia 40 = 11/09/2026 (me03 reagenda installs antigos).
    (1, "2026-08-03", "A", "cheio", "O que é / gancho curiosidade", "Objetivo", "copies_bloco_a.md#post-1", "aprovado"),
    (2, "2026-08-05", "A", "cheio", "Foco inicial: Lençóis Paulista", "Objetivo / local", "copies_bloco_a.md#post-2", "proposta"),
    (3, "2026-08-07", "A", "cheio", "Estamos finalizando / construindo", "Bastidores", "copies_bloco_a.md#post-3", "proposta"),
    (4, "2026-08-08", "A", "leve", "Vitrine: lojas locais em um só lugar", "Objetivo", "copies_bloco_a.md#post-4", "proposta"),
    (5, "2026-08-09", "A", "reuso", "Melhor da semana (provável #1 ou #4)", "Reforço", "copies_bloco_a.md#post-5", "proposta"),
    (6, "2026-08-10", "A", "cheio", "Tela: publicar produto / anúncio", "Bastidores", "copies_bloco_a.md#post-6", "proposta"),
    (7, "2026-08-12", "A", "cheio", "Por que marketplace local", "Objetivo", "copies_bloco_a.md#post-7", "proposta"),
    (8, "2026-08-14", "B", "cheio", "Lojista: vender online sem abandonar a loja física", "Lojista", None, "proposta"),
    (9, "2026-08-15", "B", "leve", "Pedidos organizados em um fluxo", "Lojista", None, "proposta"),
    (10, "2026-08-16", "B", "reuso", "Sua loja visível para quem busca na cidade", "Lojista", None, "proposta"),
    (11, "2026-08-17", "B", "cheio", "Tela: Minha loja / anúncios (bastidor)", "Bastidores + lojista", None, "proposta"),
    (12, "2026-08-19", "B", "cheio", "Estoque alinhado à vitrine", "Lojista", None, "proposta"),
    (13, "2026-08-21", "B", "cheio", "Entrega local: você vende, a cidade recebe", "Lojista", None, "proposta"),
    (14, "2026-08-22", "B", "leve", "Feito para comércio de Lençóis Paulista", "Lojista / local", None, "proposta"),
    (15, "2026-08-23", "B", "reuso", "Menos improviso no WhatsApp, mais pedido organizado", "Lojista", None, "proposta"),
    (16, "2026-08-24", "B", "cheio", "Convite soft: lojista interessado → acompanhar / falar conosco", "Lojista + CTA leve", None, "proposta"),
    (17, "2026-08-26", "C", "cheio", "Comprar de lojas da cidade, em um só lugar", "Consumidor", None, "proposta"),
    (18, "2026-08-28", "C", "cheio", "Entrega no mesmo dia", "Entrega", None, "proposta"),
    (19, "2026-08-29", "C", "leve", "Em cerca de duas horas ou agendar", "Entrega", None, "proposta"),
    (20, "2026-08-30", "C", "reuso", "Retirada na loja também (quando a loja oferecer)", "Consumidor / entrega", None, "proposta"),
    (21, "2026-08-31", "C", "cheio", "Tela: produto / carrinho / checkout (bastidor)", "Bastidores + consumidor", None, "proposta"),
    (22, "2026-09-02", "C", "cheio", "Apoiar o comércio local de Lençóis Paulista", "Consumidor / local", None, "proposta"),
    (23, "2026-09-04", "C", "cheio", "Simples: escolhe, pede, recebe na cidade", "Consumidor", None, "proposta"),
    (24, "2026-09-05", "D", "leve", "Contagem: estamos perto da publicação", "Aceleração", None, "proposta"),
    (25, "2026-09-06", "D", "reuso", "Recap curto: o que é + para quem", "Objetivo", None, "proposta"),
    (26, "2026-09-07", "D", "cheio", "Lojista: prepare-se / acompanhe @ibixmarket", "CTA lojista", None, "proposta"),
    (27, "2026-09-09", "D", "cheio", "Consumidor: em breve, lojas da cidade aqui", "CTA consumidor", None, "proposta"),
    (28, "2026-09-11", "D", "cheio", "Publicação final", "Lançamento", None, "proposta"),
]
    ...
    if existing:
        ...
        result = conn.execute(
            ...
            ),
            {
                ...
                "status": "ativa",
                "proximo_passo": (
                    "Pré-início: montar posts 1–3 · Postagens a partir de 03/08/2026 "
