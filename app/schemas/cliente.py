...
class ClienteUpdate(BaseModel):
    ...
    def validar_cnpj(cls, v):
        if v is None:
            return v
        return ClienteCreate.validar_cnpj(cls, v)
    ...
    def validar_cpf(cls, v):
        if v is None:
            return v
        return ClienteCreate.validar_cpf(cls, v)
    ...
    def validar_telefone(cls, v):
        if v is None:
            return v
        return ClienteCreate.validar_telefone(cls, v)
    ...
    def validar_uf(cls, v):
        if v is None:
            return v
        return ClienteCreate.validar_uf(cls, v)
    ...
    def validar_cep(cls, v):
        if v is None:
            return v
        return ClienteCreate.validar_cep(cls, v)
